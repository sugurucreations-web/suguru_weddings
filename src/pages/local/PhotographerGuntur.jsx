    ...
    <div className="min-h-screen">
      ...
      <div className="pt-20 pb-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div>
              ...
              <div className="bg-gradient-to-br from-slate-800 to-slate-900 text-white rounded-xl p-6">
                ...
                <div className="flex gap-4">
                  ...
                  <a href="tel:+918374962192" className="bg-white/20 hover:bg-white/30 px-6 py-2 rounded-lg font-semibold transition">
                    Call Now
                  </a>
                </div>
              </div>
          ...
          {/* Services Grid */}
          <div className="mb-16 bg-gradient-to-br from-green-50 to-emerald-50 rounded-2xl p-8 md:p-12 border border-green-200">
          ...
          {/* CTA */}
          <div className="text-center bg-gradient-to-r from-green-600 to-emerald-600 rounded-2xl p-8 md:p-12 text-white">
            <h2 className="text-3xl md:text-4xl font-bold mb-4">Book Your Guntur Wedding Photographer</h2>
